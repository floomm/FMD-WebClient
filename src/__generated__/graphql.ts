...
export type GetRqJobQueryVariables = Exact<{
  jobId: Scalars['String']['input'];
}>;


export type GetRqJobQuery = { __typename?: 'Query', rq_job?: { __typename?: 'RqJobType', isFailed?: boolean | null, isFinished?: boolean | null, status?: string | null } | null };

export type GetRqJobListQueryVariables = Exact<{ [key: string]: never; }>;


export type GetRqJobListQuery = { __typename?: 'Query', rq_job_list?: Array<{ __typename?: 'RqJobType', funcName?: string | null, id?: string | null, isFailed?: boolean | null, isFinished?: boolean | null, startedAt?: any | null, status?: string | null } | null> | null };
...
export const GetRqJobDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetRqJob"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"jobId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"rq_job"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"jobId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"jobId"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"isFailed"}},{"kind":"Field","name":{"kind":"Name","value":"isFinished"}},{"kind":"Field","name":{"kind":"Name","value":"status"}}]}}]}}]} as unknown as DocumentNode<GetRqJobQuery, GetRqJobQueryVariables>;
