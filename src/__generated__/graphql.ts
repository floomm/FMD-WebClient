...
export type ReportInfoWithAppReferenceFragment = { __typename?: 'ApkScannerReportType', id?: string | null, reportDate: any, scannerName: string, scannerVersion: string, androidAppIdReference: { __typename?: 'AndroidAppType', id: string, filename: string } } & { ' $fragmentName'?: 'ReportInfoWithAppReferenceFragment' };
